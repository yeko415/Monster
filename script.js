...
function prepareModel(object) {
  ...
  // Önce ölçekle, sonra yeniden ölçüp ortala.
  // Böylece model yanlışlıkla ekranın dışına taşmaz.
  ...
  if (maxSize > 0) {
    object.scale.setScalar(4.1 / maxSize);
  }
  ...
  console.log("GLB hazır:", box.getSize(new THREE.Vector3()).toArray());
}
